...
const confirmEmailTemplate = (verificationCode: number) => `<head>
      ...
      >
        <tr>
          ...
          >
            <p style="margin: 0">
              ...
              confirm your account. Please use the code below to confirm your account.
            </p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td
            ...
            "
          >
            <p style="margin: 0">Cheers,<br />Bookry Club</p>
          </td>
        </tr>
      </table>
    </td>
